...
- 🗑️ **Удален старый монолитный bot.py** (3511 строк)
- 🔄 **bot_new.py переименован в bot.py** (167 строк)
- 📊 **Сокращение кода на 95%** благодаря модульной архитектуре
### Завершено
...
## [2.0.5] - 2025-07-30
### Исправлено
- Исправлено дублирование сообщений при поиске по ФИО
- Исправлено отображение фотографий в результатах поиска - теперь фото отправляется вместе с текстом в одном сообщении
- Улучшена логика отображения фотографий для всех типов поиска (ФИО, должность, отдел)
### Изменено
- Фотографии теперь отображаются как изображения, а не как ссылки
- При наличии фото у первого результата, оно отправляется как главное изображение сообщения

## [2.0.4] - 2025-07-30
### Добавлено
- Отображение фотографий в результатах поиска сотрудников
- Кнопки "⬅️ Назад к поиску" и "🏠 Главное меню" под результатами поиска
- Кнопки "✅ Принять" и "❌ Отклонить" для каждой заявки на авторизацию
### Улучшено
- Улучшен пользовательский интерфейс поиска и администрирования
- Упрощена навигация между разделами бота
